...
namespace Microsoft.Azure.WebJobs.Extensions.EventGrid.Tests
{
    public class UnitTests
    {
        ...
        private void DummyMethodForOutputBinding(EventGridEvent message) { }

        [Fact]
        public async Task OutputBindingAsyncTest()
        {
            MethodBase methodbase = this.GetType().GetMethod(nameof(DummyMethodForOutputBinding), BindingFlags.NonPublic | BindingFlags.Instance);
            ParameterInfo[] arrayParam = methodbase.GetParameters();
